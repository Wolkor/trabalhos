...
public class AnimatorController {
    ...
    private static final int defaultNumberOfObjects = 2;
    ...
    private void createObjectSet() throws Exception {
        ...
        switch (shapeType) {
            ...
            case Square: objs.addSquare(nShapes, dim, pathShapes); break;
            case Circle: objs.addCircles(nShapes, dim, pathShapes); break;
            case Triangle: objs.addTriangles(nShapes, dim, pathShapes); break;
        }
